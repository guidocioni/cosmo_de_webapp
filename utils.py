...
def get_run():
    ...
    if (utc_now.replace(hour=1, minute=0, second=0, microsecond=0) 
        <= utc_now < utc_now.replace(hour=4, minute=0, second=0, microsecond=0)):
        run="00"
    elif (utc_now.replace(hour=4, minute=0, second=0, microsecond=0) 
        <= utc_now < utc_now.replace(hour=7, minute=0, second=0, microsecond=0)):
        run="03"
    elif (utc_now.replace(hour=7, minute=0, second=0, microsecond=0) 
        <= utc_now < utc_now.replace(hour=10, minute=0, second=0, microsecond=0)):
        run="06"
    elif (utc_now.replace(hour=10, minute=0, second=0, microsecond=0) 
        <= utc_now < utc_now.replace(hour=13, minute=0, second=0, microsecond=0)):
        run="09"
    elif (utc_now.replace(hour=13, minute=0, second=0, microsecond=0) 
        ...
        <= utc_now < utc_now.replace(hour=19, minute=0, second=0, microsecond=0)):
        run="15"
    elif (utc_now.replace(hour=19, minute=0, second=0, microsecond=0) 
        <= utc_now < utc_now.replace(hour=22, minute=0, second=0, microsecond=0)):
        run="18"
    elif (utc_now.replace(hour=22, minute=0, second=0, microsecond=0) 
        <= utc_now < utc_now.replace(hour=23, minute=0, second=0, microsecond=0)):
        run="21"
...
def download_extract_files(urls):
    ...
    if len(urls_list) > multiprocessing.cpu_count():    
...
def get_projection_cartopy(plt, projection="de", compute_projection=False):
